     ...
     *     iperm(nx) 
c-----------------------------------------------------------------------
c this subroutine initializes selects and initializes a mesh among a few
c choices. So far there are 9 initial meshs provided and the user can
...
c     
c     call chkelmt (nx, x, y, nelx, ijk, node)
c     
      return
      end
c--------------------------------------------------------
