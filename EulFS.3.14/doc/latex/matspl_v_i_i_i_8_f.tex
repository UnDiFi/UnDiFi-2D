\hypertarget{matspl_v_i_i_i_8_f}{}\doxysection{src/euler/matspl\+V\+I\+II.F File Reference}
\label{matspl_v_i_i_i_8_f}\index{src/euler/matsplVIII.F@{src/euler/matsplVIII.F}}
\doxysubsection*{Functions/\+Subroutines}
\begin{DoxyCompactItemize}
\item 
subroutine \mbox{\hyperlink{matspl_v_i_i_i_8_f_a3d02669977e4aa3efe58c2203a88c330}{Mat\+Split\+V\+I\+II}} (I\+E\+L\+EM, N\+D\+IM, N\+O\+R\+D\+ER, V\+E\+CN, Jacobian\+Matrix, L\+DJ, K\+M\+AT, K\+P\+OS, K\+N\+EG, V\+L\+E\+FT, V\+R\+I\+G\+HT, L\+DA, WR, L\+P\+OS, L\+N\+EG, E\+I\+G\+E\+N\+D\+E\+CO)
\begin{DoxyCompactList}\small\item\em {\bfseries{Mat\+Split\+IX}} \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Function/\+Subroutine Documentation}
\mbox{\Hypertarget{matspl_v_i_i_i_8_f_a3d02669977e4aa3efe58c2203a88c330}\label{matspl_v_i_i_i_8_f_a3d02669977e4aa3efe58c2203a88c330}} 
\index{matsplVIII.F@{matsplVIII.F}!MatSplitVIII@{MatSplitVIII}}
\index{MatSplitVIII@{MatSplitVIII}!matsplVIII.F@{matsplVIII.F}}
\doxysubsubsection{\texorpdfstring{MatSplitVIII()}{MatSplitVIII()}}
{\footnotesize\ttfamily subroutine Mat\+Split\+V\+I\+II (\begin{DoxyParamCaption}\item[{integer}]{I\+E\+L\+EM,  }\item[{integer}]{N\+D\+IM,  }\item[{integer}]{N\+O\+R\+D\+ER,  }\item[{double precision, dimension($\ast$)}]{V\+E\+CN,  }\item[{double precision, dimension(ldj,$\ast$)}]{Jacobian\+Matrix,  }\item[{integer}]{L\+DJ,  }\item[{double precision, dimension(lda,$\ast$)}]{K\+M\+AT,  }\item[{double precision, dimension(lda,$\ast$)}]{K\+P\+OS,  }\item[{double precision, dimension(lda,$\ast$)}]{K\+N\+EG,  }\item[{double precision, dimension(lda,$\ast$)}]{V\+L\+E\+FT,  }\item[{double precision, dimension(lda,$\ast$)}]{V\+R\+I\+G\+HT,  }\item[{integer}]{L\+DA,  }\item[{double precision, dimension($\ast$)}]{WR,  }\item[{double precision, dimension($\ast$)}]{L\+P\+OS,  }\item[{double precision, dimension($\ast$)}]{L\+N\+EG,  }\item[{logical}]{E\+I\+G\+E\+N\+D\+E\+CO }\end{DoxyParamCaption})}
